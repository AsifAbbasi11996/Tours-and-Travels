...
const Continent = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const continentResponse = await fetch('https://codify-api-541e.onrender.com/travel/continent');
            ...
            try {
                const countryResponse = await fetch('https://codify-api-541e.onrender.com/travel/country/all');
