                    ...
                    <div className="second">
                        <div className="city city1">
                            ...
                            <div className="text">
                                <h3>New York City</h3>
                                <p><span><i class="ri-map-pin-line"></i></span>U.S.A</p>
                                <NavLink to='/spot' state={{ PackageName: 'New York City and Hudson Valley Gateway' }}><button><span><i class="ri-play-list-add-line"></i></span>Book Now</button></NavLink>
                            </div>
                        </div>
                        <div className="city city2">
                            <div className="text">
                                <h3>Mumbai City</h3>
                                <p><span><i class="ri-map-pin-line"></i></span>India</p>
                                <NavLink to='/spot' state={{ PackageName: 'Mumbai City Exploration' }}><button><span><i class="ri-play-list-add-line"></i></span>Book Now</button></NavLink>
                            </div>
                            <div className="img">
                                <img src={mumbai} alt="" />
                            </div>
